...
public class ModBlocks {
    ...
    // purple ice registration
    public static final RegistryObject<Block> PURPLE_ICE = BLOCKS.register("purple_ice", () -> new PurpleIce());

    public static final RegistryObject<BlockItem> PURPLE_ICE_ITEM = ITEMS.register("purple_ice", () -> new BlockItem(PURPLE_ICE.get(), new Item.Properties()));
